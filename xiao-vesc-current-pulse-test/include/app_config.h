...
constexpr char kFirmwareName[] = "xiao-vesc-current-pulse-test";
constexpr char kFirmwareVersion[] = "0.2.0-stage2-current-pulse";
constexpr char kBoardName[] = "Seeed Studio XIAO ESP32S3 Sense";
constexpr uint8_t kActiveStage = 2;
// Stage 2: fixed, positive, one-shot duty test. Change only after review.
constexpr float kPulseDuty = 0.01f;
constexpr uint32_t kPulseDurationMs = 500UL;
