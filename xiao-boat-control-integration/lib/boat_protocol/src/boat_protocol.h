...
static_assert(sizeof(ControlModeCommandPayload)==24,"ControlModeCommandPayload size"); static_assert(sizeof(ManualCommandPayload)==40,"ManualCommandPayload size"); static_assert(sizeof(HeadingTargetPayload)==28,"HeadingTargetPayload size"); static_assert(sizeof(ControlCommandAckPayload)==36,"ControlCommandAckPayload size"); static_assert(sizeof(ControlSnapshotPayload)==190,"ControlSnapshotPayload size"); static_assert(sizeof(InaStatusPayload)==32,"InaStatusPayload size"); static_assert(sizeof(VescTelemetryPayload)==48,"VescTelemetryPayload size"); static_assert(sizeof(WaypointSetPayload)==276,"WaypointSetPayload size"); static_assert(sizeof(WaypointAckPayload)==16,"WaypointAckPayload size");
