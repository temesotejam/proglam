...
namespace vlog {
enum class Type:uint8_t{PcaConfig=1,ServoCommand=2,ServoOutput=3,StateChange=4,EstopEvent=5,WatchdogEvent=6,PcaStatus=7,SystemStatus=8,LogEnd=9}; enum class State:uint8_t{NoCard,Ready,Logging,Stopping,Error};
