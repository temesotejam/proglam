...
int main() {
  ...
  proposal_min::Input in{}; in.nowUs=1000000; in.start=true; in.heartbeatOk=true; in.gnss={35.0,139.0,1.2f,0.2f,1000000,true}; in.imu={0.1f,0.02f,0.01f,0.0f,0.0f,0.0f,1000000,true}; in.tof={ranges,status,8,1000000,true}; in.waypoints=route; in.waypointCount=3;
