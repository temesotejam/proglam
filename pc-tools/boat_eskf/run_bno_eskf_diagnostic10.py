...
root = os.environ.get("CAPTURE_ROOT", r"C:\Users\arika\Documents\PlatformIO\proglam\pc-tools\boat_eskf\captures\BNO_ESKF_DIAGNOSTIC10_20260803")
...
meta = {"run_label": "BNO_ESKF_DIAGNOSTIC10_20260803", "ports": ports, "baud": baud,
...
start_url = "http://192.168.4.1/api/log/start?duration_s=10&bno_capture=1&bno_log_enqueue=1&uart_rx_diag=dispatch&eskf_reset_at_start=1"
