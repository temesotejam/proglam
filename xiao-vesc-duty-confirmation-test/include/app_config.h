...
constexpr char kFirmwareName[] = "xiao-vesc-duty-confirmation-test";
constexpr char kFirmwareVersion[] = "0.3.0-stage2-duty-confirm";
...
constexpr uint32_t kPulseDurationMs = 1000UL;
